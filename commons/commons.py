...
def read_excel_electrohuila():
    try:
        ...
        # Filtrar columna supplier para encontrar la comercializadora
        df = df[df['Supplier'].str.contains('ELECTRIFICADORA DEL HUILA SA ESP', case=False, na=False)]
...
def read_excel_eebpsa():
    try:
        ...
        # Filtrar columna supplier para encontrar la comercializadora
        df = df[df['Supplier'].str.contains('EMP DE ENERGIA DEL BAJO PUTUMAYO SA ESP', case=False, na=False)]
